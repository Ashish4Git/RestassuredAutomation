...
public class TC001_GET_Request {
	...
	void getweatherDetails() 
	{
		...
		/*Validation : Status code & Status Line:
		...
		// OR
		//TestNG Assert : To check/verify if this status code is as per expectation or not.
		Assert.assertEquals(statusCode, 200);//Pass above statusCode and expected one i.e. 200
		

		//2.status line verification
		String statusLine=response.getStatusLine(); //STRING
		//Capture the status line from response and store in var statusLine
